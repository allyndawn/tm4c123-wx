...
extern void Timer0A_Handler( void ); // Added
extern void Timer0B_Handler( void ); // Added
...
#pragma call_graph_root = "interrupt"
__weak void Timer0A_Handler( void ) { while (1) {} } // Added
#pragma call_graph_root = "interrupt"
__weak void Timer0B_Handler( void ) { while (1) {} } // Added
